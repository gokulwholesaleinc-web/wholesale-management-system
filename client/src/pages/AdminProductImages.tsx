      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="mb-8">
          <CardHeader>
            ...
            <CardDescription>
              Select a product from the table below and enter a new image URL to update it.
            </CardDescription>
          </CardHeader>
          <CardHeader>
            <CardTitle>Update Product Images</CardTitle>
                  ...
                  <TableBody>
                    {filteredProducts.length === 0 ? (
                      ...
                      filteredProducts.map((product: any) => (
                        <TableRow 
                          key={product.id} 
                          className={`cursor-pointer hover:bg-gray-50 ${selectedProduct === product.id ? 'bg-gray-100' : ''}`}
